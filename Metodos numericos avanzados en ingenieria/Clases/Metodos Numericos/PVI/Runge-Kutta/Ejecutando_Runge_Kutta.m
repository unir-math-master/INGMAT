...
%[x1, y1] = RungeKutta('funcion1', a, b, intervalo, 1);
%[x2, y2] = RungeKutta('funcion1', a, b, 2*intervalo, 1);

[x1, y1] = RungeKutta_1582('funcion1', a, b, intervalo, 1);
[x2, y2] = RungeKutta_1582('funcion1', a, b, 2*intervalo, 1);
